        ...
        {step === 1 && (
          <form onSubmit={handleEmailSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full rounded-lg bg-yellow-500 px-4 py-2 font-medium text-white transition hover:bg-yellow-600 disabled:bg-gray-400"
            >
        ...
        {step === 2 && (
          <form onSubmit={handleOtpSubmit} className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full rounded-lg border border-yellow-500 px-4 py-2 font-medium text-yellow-600 transition hover:bg-yellow-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {resendCooldown > 0
